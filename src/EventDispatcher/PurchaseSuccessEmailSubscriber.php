...
class PurchaseSuccessEmailSubscriber implements EventSubscriberInterface
{
    ...
    public function __construct(LoggerInterface $logger, MailerInterface $mailer, Security
	$security)
    {
        $this->logger = $logger;
		$this->mailer = $mailer;
    ...
    {
    	// 1 - Récupérer l'user actuellement en ligne (pour connaitre son adresse)
		// (Security)
		/**
		 * @var User
		 */
		...
		// 2 - Récupérer sa commande (je la trouverai dans PurchaseSuccessEvent)
